...
export const projects = [
  ...
  { id: 2, 
    ...
    textSets: [
    {
      title: "",
      texts: [
        "Like geological layers that record the passage of time, the project visualizes the material transformation of books, expressing both their softness and structural solidity.",
        ""
      ],
      position: { top: "48%", left: "55%" }, // 반응형 가능하게 % 사용
      color: "#606060",
      width: "500px"
...
export const projectsKo: Projectsko[] = [
  {
    ...
    year: 2024,
    script: "",
    script2: "개인 프로젝트 / 297x420mm, 120g 1도 인쇄와 실크스크린",
    category: "그래픽 디자인",
    ...
    textSets: [
    {
      title: "",
      texts: [
        "지층이 시간의 흐름을 기록하듯, 이 프로젝트는 책의 물질적 변화를 시각화하여, 책의 부드러움과 견고함을 동시에 표현합니다. 제작년도가 오래된 순서를 기반으로 중앙도서관의 100권이 넘는 책의 구조와 층위를 분석하여 시각화하였습니다. ",
        ""
      ],
      position: { top: "48%", left: "55%" }, // 반응형 가능하게 % 사용
      color: "#606060",
    ...
    year: 2022,
    script: "",
    script2: "개인 프로젝트 / MapBox, p5.js / 297x420mm, 150g",
    category: "웹 + 편집 디자인",
  ...
  },
  {
    ...
    year: 2024,
    script: "",
    script2: "2인 팀 협업 / 제19회 한국문화공간건축협회 차세대 문화공간 공모전 입선 수상, 이화여자대학교 <이 작품을 주목해라> 2024 수상",
  ...
  },
   {
    ...
    year: 2024,
    script: "",
    script2: "디자인팀 협업 / 홍대 KT&G 상상마당에서 개최",
  ...
  },
  {
    ...
    year: 2023,
    script: "",
    script2: "개인 프로젝트 / 광목천과 실크스크린, 2000mm / 2024년 창신동 차차티 클럽에서 전시 진행",
    category: "그래픽 디자인",
