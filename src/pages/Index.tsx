  ...
  return (
    <div className="min-h-screen bg-white text-black font-helvetica">
      ...
      <header className="container mx-auto px-10 py-12">
        {/* Left-Center 그룹 */}
        <div className="flex flex-wrap md:flex-nowrap items-start gap-[60px]">
          {/* Left */}
    ...
    >
      ...
      <section className="relative w-full h-screen flex justify-start items-start overflow-visible mt-[-170px] z-0">
        ...
        >
          {/* 영역 텍스트 */}
          <p
            style={{ left: 0.064 * baseWidth, bottom: 0.045 * baseHeight }}
          ...
          <p
            style={{ left: 0.38 * baseWidth, bottom: 0.61 * baseHeight }}
            className="absolute text-gray-400 text-2xl md:text-2xl w-[180px] origin-left"
          >
            Editorial / Graphic Design
          </p>
          <p
            style={{ left: 0.047 * baseWidth, top: 0.14 * baseHeight }}
            className="absolute text-gray-400 text-2xl w-[130px] md:text-2xl"
          >
            Video / Web Design
          </p>
          <p
            style={{ left: 0.84 * baseWidth, top: 0.56 * baseHeight }}
          ...
          <div
            ...
            style={{
              ...
              left: baseWidth - 0.06 * baseWidth - 20,
              width: 0,
              height: 0,
